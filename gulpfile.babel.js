...
import svgSprite from './config/svg-sprite';
...
gulp.task('docs:site', ['styles:lint', 'svg-sprite'], pages);
...
gulp.task('default', ['audio', 'icons', 'svg-sprite', 'dist:scripts', 'dist:styles', 'docs:scripts', 'docs:styles', 'docs:site', 'media']);
gulp.task('dist', ['audio', 'icons', 'svg-sprite', 'dist:scripts', 'dist:styles', 'media']);
gulp.task('docs', ['icons', 'svg-sprite', 'docs:scripts', 'docs:styles', 'docs:site', 'media']);
