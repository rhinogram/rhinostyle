...
function (_React$Component) {
  ...
  function DropdownFilter() {
        ...
        if (child.type === _.DropdownMenuItem) {
          returnChild = _react.default.cloneElement(child, {
            onClick: function onClick() {
              return _this.itemClick(child);
            },
            active: _this.props.activeKey && child.props.id === _this.props.activeKey,
            key: child.props.id
          });
    ...
    _defineProperty(_assertThisInitialized(_this), "itemClick2", function () {
      _this.props.handleToggle();
    });

    _defineProperty(_assertThisInitialized(_this), "itemClick", function (child) {
      ...
      if (id) {
        if (_this.props.onSelect) {
          _this.props.updateActiveKey(id, icon);

          _this.props.onSelect(id, icon);
        } else {
          _this.props.updateActiveKey(id, icon);
        }
      }
  ...
  _createClass(DropdownFilter, [{
    ...
    value: function render() {
      ...
      })), _react.default.createElement(_.DropdownMenuScroll, null, items));
    }
  }]);
...
DropdownFilter.propTypes = {
  ...
  updateActiveKey: _propTypes.default.func
};
