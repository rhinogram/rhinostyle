...
function (_React$Component) {
  ...
  function TabsContent() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(TabsContent)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this), "getChildren", function () {
      var returnChild = null;
      var children = _this.props.children;
      return _react.default.Children.map(children, function (child) {
        if (child.type === _.TabContentPane) {
  ...
  _createClass(TabsContent, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)('tabs-content', className);
