...
function (_Component) {
  ...
  function ToggleButton() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleClick", function () {
      if (_this.props.onClick) {
        _this.props.onClick(_this.props.variable.variable, _this.props.variable.id);
      }
    });
  ...
  _createClass(ToggleButton, [{
    ...
    value: function render() {
      ...
      var buttonBaseClass = 'toggle-button';
      var toggleButtonStyleClasses = {
        'toggle-button--strikethrough': !available,
        'button--outline-primary': available
      };
      var classes = (0, _classnames.default)(buttonBaseClass, className, _objectSpread({}, toggleButtonStyleClasses));
...
ToggleButton.propTypes = {
  ...
  variable: _propTypes.default.object.isRequired
};
