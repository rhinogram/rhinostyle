...
function (_React$Component) {
  ...
  function NavTabs() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(NavTabs)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this), "getChildren", function () {
      var returnChild = null;
      var children = _this.props.children;
      return _react.default.Children.map(children, function (child) {
        if (child.type === _.NavTabsItem) {
          returnChild = _react.default.cloneElement(child, {
            active: child.props.id === _this.props.activeKey,
            onClick: function onClick() {
              return _this.props.onSelect(child.props.id);
            }
          });
        } else {
          returnChild = child;
  ...
  _createClass(NavTabs, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)('nav-tabs', className, {
...
NavTabs.propTypes = {
  ...
  justified: _propTypes.default.oneOf(['auto', 'equal', 'none']),
