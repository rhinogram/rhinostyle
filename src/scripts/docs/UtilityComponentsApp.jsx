  ...
  <Fragment>
    ...
    <section className="site-section">
      ...
      <div className="u-m-b-large">
        <p>
          Variable-width content; like buttons and/or list items,
          can wrap at certain widths within our app when placed next to each other. We can use the
          <code>u-inline-grid</code> class to provide adequate spacing.
        </p>
        <p>
          <strong>Note:</strong> This utility adds margin to each decendant of the class,
          so if the component you are interacting with has margin, wrap it in another element
          (such as a <code>&lt;div&gt;</code>) to get around adverse spacing effects.
          There should be no whitespace modifiers directly attached.
        </p>
      </div>
