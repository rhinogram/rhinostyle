...
class ScrollBarApp extends React.Component {
  static displayName = 'Rhinostyle Scroll Bar Examples';
    ...
    return (
      <div>
        ...
        <section className="site-section">
          ...
          <p className="site-copy">We are using <a href="http://malte-wessel.github.io/react-custom-scrollbars/" target="_blank">react-custom-scrolbars</a> for scrolling within areas of the page.</p>
