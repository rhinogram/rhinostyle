...
function (_React$Component) {
  _inherits(RhinoSwitch, _React$Component);

  function RhinoSwitch() {
    var _getPrototypeOf2;

    var _this;

    _classCallCheck(this, RhinoSwitch);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(RhinoSwitch)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(RhinoSwitch, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)('rhinoswitcher', className);
      return _react.default.createElement("div", {
        className: "form__group rhinoswitcher__form-group"
      }, _react.default.createElement("div", {
        className: classes
      }, _react.default.createElement("input", {
        type: "checkbox",
        className: "rhinoswitcher__input",
        name: name,
        id: this.id,
        checked: checked,
        disabled: disabled,
