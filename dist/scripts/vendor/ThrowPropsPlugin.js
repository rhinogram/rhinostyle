...
exports.VelocityTracker = exports.default = exports.ThrowPropsPlugin = void 0;
  ...
  p._onInitTween = function (target, value, tween, index) {
    ...
    for (p in value) {
      if (p !== "resistance" && p !== "checkpoint" && p !== "preventOvershoot" && p !== "linkedProps" && p !== "radius") {
        ...
        } else if (_typeof(curProp) === "object" && !isNaN(curProp.velocity)) {
...
var ThrowPropsPlugin = _TweenLite._gsScope.ThrowPropsPlugin;
exports.default = exports.ThrowPropsPlugin = ThrowPropsPlugin;
var VelocityTracker = _TweenLite._gsScope.com.greensock.utils.VelocityTracker;
